define({ "api": [
  ...
  {
    "type": "post",
    "url": "card/get-electric",
    "title": "宿舍电控查询",
    "version": "1.0.5",
    "name": "get_electric",
    "group": "Card",
    "description": "<p>查用电、购电情况，支持本部23，26，27，29，30，32栋</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
    ...
    "success": {
      ...
      "examples": [
        {
          "title": "正常返回",
          "content": "{\"code\":0,\"msg\":\"\",\"data\":[{\"electric\":\"5.0\",\"money\":\"3.24\",\"time\":\"2017-09-02 10:00:00\"},{\"electric\":\"37.51\",\"money\":\"24.27\",\"time\":\"2017-09-03 10:00:00\"},{\"electric\":\"29.92\",\"money\":\"19.36\",\"time\":\"2017-09-04 10:00:01\"},{\"electric\":\"21.2\",\"money\":\"13.72\",\"time\":\"2017-09-05 10:00:00\"},{\"electric\":\"10.91\",\"money\":\"7.06\",\"time\":\"2017-09-06 10:00:01\"}]}",
          "type": "json"
        }
      ]
    },
        ...
        "Error 4xx": [
          {
            ...
            "optional": false,
            "field": "6300",
            "description": "<p>房间号错误或者最近一周系统无记录</p>"
          },
          {
            "group": "Error 4xx",
            "optional": false,
            "field": "6301",
            "description": "<p>楼号错误或者暂不支持</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "post",
    "url": "jw/get-empty-classroom",
    "title": "获取空课室",
    "version": "1.0.6",
    "name": "get_empty_classroom",
    "group": "Jw",
    "description": "<p>获取空课室</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
          ...
          },
          {
            ...
            "optional": false,
            "field": "building",
            "description": "<p>教学楼编号，[&quot;J1&quot;=&gt;&quot;第一教学楼&quot;,&quot;B4&quot;=&gt;&quot;经管实验楼&quot;,&quot;S1&quot;=&gt;&quot;实验楼&quot;,&quot;Z1&quot;=&gt;&quot;综合楼&quot;,&quot;B5&quot;=&gt;&quot;第三教学楼&quot;,&quot;SJ3&quot;=&gt;&quot;厚德楼&quot;,&quot;SJ1&quot;=&gt;&quot;励学楼&quot;,&quot;SS1&quot;=&gt;&quot;拓新楼&quot;,&quot;SJ2&quot;=&gt;&quot;笃行楼&quot;];</p>"
          },
          {
            "group": "Parameter",
            "type": "int",
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "data.item[0]",
            "description": "<p>课室编号</p>"
          },
          {
            "group": "Success 200",
            "type": "Boolean",
            "optional": false,
            "field": "data.item[1-42]",
            "description": "<p>周一到周日每日六大节该课室是否为空</p>"
          }
        ]
      },
      "examples": [
  ...
  {
    "type": "post",
    "url": "jw/get-exam-schedule",
    "title": "获取考试安排表",
    "version": "1.0.6",
    "name": "get_exam_schedule",
    "group": "Jw",
    "description": "<p>获取考试安排表</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "checkId",
            "description": "<p>不明字段，在当前借阅页面里可获取</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
  ...
  },
  {
    ...
    "description": "<p>清空服务器中该账号的缓存，达到彻底退出登录</p>",
  ...
  {
    "type": "post",
    "url": "work/get-app-tips",
    "title": "获取每日启动Tips",
    "version": "1.0.1",
    "name": "get_app_tips",
    "group": "Work",
    "description": "<p>获取每日启动Tips内容</p>",
    "success": {
      "fields": {
        "Success 200": [
          {
          ...
          },
          {
            ...
            "optional": false,
            "field": "data.version",
            "description": "<p>Tips版本，用于区分Tips</p>"
          },
          {
            "group": "Success 200",
            "type": "boolean",
          ...
          },
          {
            ...
            "description": "<p>Tips有效时间（开始），格式：yyyy-MM-dd HH:mm:ss</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
          ...
          },
          {
            ...
            "optional": false,
            "field": "data.openUrl",
            "description": "<p>http等浏览器支持的地址，非空的情况会在app多一个按钮用于调用浏览器打开</p>"
          }
        ]
      },
      "examples": [
        {
          "title": "正常返回",
          "content": "{\"code\":0,\"msg\":\"\",\"data\":{\"version\":1,\"enable\":true,\"title\":\"你的反馈是我更新的动力\",\"message\":\"有功能需求的话可以提下反馈，不过近期毕设答辩，会晚一点更新，另无薪招聘技术大佬呀~\",\"startTime\":\"2017-04-17 20:58:22\",\"endTime\":\"2017-04-17 22:59:28\",\"openUrl\":\"http://www.wintercoder.com:8080/\"}}",
          "type": "json"
        }
      ]
    },
